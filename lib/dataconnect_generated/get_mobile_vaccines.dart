...
class GetMobileVaccinesVariablesBuilder {
  ...
  Deserializer<GetMobileVaccinesData> dataDeserializer = (dynamic json)  => GetMobileVaccinesData.fromJson(jsonDecode(json));
  
  Future<QueryResult<GetMobileVaccinesData, void>> execute({QueryFetchPolicy fetchPolicy = QueryFetchPolicy.preferCache}) {
    return ref().execute(fetchPolicy: fetchPolicy);
  }

  QueryRef<GetMobileVaccinesData, void> ref() {
    
    return _dataConnect.query("GetMobileVaccines", dataDeserializer, emptySerializer, null);
  }
}
...
class GetMobileVaccinesVaccines {
  ...
  shortName = json['shortName'] == null ? null : nativeFromJson<String>(json['shortName']),
  description = json['description'] == null ? null : nativeFromJson<String>(json['description']),
  recommendedAge = json['recommendedAge'] == null ? null : nativeFromJson<String>(json['recommendedAge']),
  requiredDoses = nativeFromJson<int>(json['requiredDoses']),
  intervalDays = json['intervalDays'] == null ? null : nativeFromJson<int>(json['intervalDays']),
  prevents = json['prevents'] == null ? null : (json['prevents'] as List<dynamic>)
        .map((e) => nativeFromJson<String>(e))
        .toList(),
  targetGroups = json['targetGroups'] == null ? null : (json['targetGroups'] as List<dynamic>)
        .map((e) => nativeFromJson<String>(e))
        .toList(),
  doseSchedule = json['doseSchedule'] == null ? null : AnyValue.fromJson(json['doseSchedule']),
  expectedReactions = json['expectedReactions'] == null ? null : (json['expectedReactions'] as List<dynamic>)
        .map((e) => nativeFromJson<String>(e))
        .toList(),
  warningSigns = json['warningSigns'] == null ? null : (json['warningSigns'] as List<dynamic>)
        .map((e) => nativeFromJson<String>(e))
        .toList(),
  contraindications = json['contraindications'] == null ? null : (json['contraindications'] as List<dynamic>)
        .map((e) => nativeFromJson<String>(e))
        .toList(),
  sourceName = json['sourceName'] == null ? null : nativeFromJson<String>(json['sourceName']),
  sourceUrl = json['sourceUrl'] == null ? null : nativeFromJson<String>(json['sourceUrl']),
  sourceUpdatedAt = json['sourceUpdatedAt'] == null ? null : Timestamp.fromJson(json['sourceUpdatedAt']),
  calendarVersion = json['calendarVersion'] == null ? null : nativeFromJson<String>(json['calendarVersion']),
  ...
  bool operator ==(Object other) {
    ...
    final GetMobileVaccinesVaccines otherTyped = other as GetMobileVaccinesVaccines;
  ...
  @override
  int get hashCode => Object.hashAll([id.hashCode, legacyVaccineId.hashCode, name.hashCode, shortName.hashCode, description.hashCode, recommendedAge.hashCode, requiredDoses.hashCode, intervalDays.hashCode, prevents.hashCode, targetGroups.hashCode, doseSchedule.hashCode, expectedReactions.hashCode, warningSigns.hashCode, contraindications.hashCode, sourceName.hashCode, sourceUrl.hashCode, sourceUpdatedAt.hashCode, calendarVersion.hashCode, active.hashCode]);
  ...
  Map<String, dynamic> toJson() {
    ...
    if (targetGroups != null) {
      json['targetGroups'] = targetGroups?.map((e) => nativeToJson<String>(e)).toList();
    }
    if (doseSchedule != null) {
      json['doseSchedule'] = doseSchedule!.toJson();
    }
    if (expectedReactions != null) {
      json['expectedReactions'] = expectedReactions?.map((e) => nativeToJson<String>(e)).toList();
    }
    if (warningSigns != null) {
      json['warningSigns'] = warningSigns?.map((e) => nativeToJson<String>(e)).toList();
    }
    if (contraindications != null) {
      json['contraindications'] = contraindications?.map((e) => nativeToJson<String>(e)).toList();
    }
    if (sourceName != null) {
