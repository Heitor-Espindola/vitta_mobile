...
enum PatientAccessKind { SELF, DEPENDENT, CAREGIVER, PROFESSIONAL }
...
enum RelationshipType { MOTHER, FATHER, LEGAL_GUARDIAN, TUTOR, CAREGIVER }
...
class MobileConnectorConnector {
  CompleteMobileRegistrationVariablesBuilder completeMobileRegistration({
    required String name,
    required DateTime birthDate,
    required String email,
    required String cpf,
  }) {
    return CompleteMobileRegistrationVariablesBuilder(
      dataConnect,
      name: name,
      birthDate: birthDate,
      email: email,
  ...
  CreateMobileDependentVariablesBuilder createMobileDependent({
    required String guardianPatientId,
    required String name,
    required DateTime birthDate,
    required String cpf,
    required RelationshipType relationshipType,
  }) {
    return CreateMobileDependentVariablesBuilder(
      dataConnect,
  ...
  upsertAccessibleEmergencyContact({
    ...
    return UpsertAccessibleEmergencyContactVariablesBuilder(
      dataConnect,
      patientId: patientId,
      name: name,
      phone: phone,
  ...
  GetAccessiblePatientProfileVariablesBuilder getAccessiblePatientProfile({
    required String patientId,
  }) {
    return GetAccessiblePatientProfileVariablesBuilder(
      dataConnect,
      patientId: patientId,
    );
  }
  ...
  getAccessiblePatientVaccinations({required String patientId}) {
    return GetAccessiblePatientVaccinationsVariablesBuilder(
      dataConnect,
      patientId: patientId,
    );
  }
  ...
  GetAccessibleEmergencyContactVariablesBuilder getAccessibleEmergencyContact({
    required String patientId,
  }) {
    return GetAccessibleEmergencyContactVariablesBuilder(
      dataConnect,
      patientId: patientId,
    );
  }
