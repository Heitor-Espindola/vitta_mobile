...
class CreateMobileDependentVariablesBuilder {
  ...
  CreateMobileDependentVariablesBuilder(
    this._dataConnect, {
  ...
  Deserializer<CreateMobileDependentData> dataDeserializer = (dynamic json) =>
      CreateMobileDependentData.fromJson(jsonDecode(json));
  Serializer<CreateMobileDependentVariables> varsSerializer =
      (CreateMobileDependentVariables vars) => jsonEncode(vars.toJson());
  Future<
    OperationResult<CreateMobileDependentData, CreateMobileDependentVariables>
  >
  execute() {
    return ref().execute();
  }
  ...
  MutationRef<CreateMobileDependentData, CreateMobileDependentVariables> ref() {
    CreateMobileDependentVariables vars = CreateMobileDependentVariables(
...
class CreateMobileDependentUserInsert {
  ...
  bool operator ==(Object other) {
    ...
    final CreateMobileDependentUserInsert otherTyped =
        other as CreateMobileDependentUserInsert;
  ...
  CreateMobileDependentUserInsert({required this.id});
}
...
class CreateMobileDependentPatientInsert {
  ...
  bool operator ==(Object other) {
    ...
    final CreateMobileDependentPatientInsert otherTyped =
        other as CreateMobileDependentPatientInsert;
    return id == otherTyped.id;
  }
  ...
  CreateMobileDependentPatientInsert({required this.id});
}
...
class CreateMobileDependentFamilyRelationshipInsert {
  ...
  bool operator ==(Object other) {
    ...
    final CreateMobileDependentFamilyRelationshipInsert otherTyped =
        other as CreateMobileDependentFamilyRelationshipInsert;
  ...
  @override
  int get hashCode =>
      Object.hashAll([fromPatientId.hashCode, toPatientId.hashCode]);
...
class CreateMobileDependentPatientAccessInsert {
  ...
  bool operator ==(Object other) {
    ...
    final CreateMobileDependentPatientAccessInsert otherTyped =
        other as CreateMobileDependentPatientAccessInsert;
...
class CreateMobileDependentData {
  ...
  CreateMobileDependentData.fromJson(dynamic json)
    : user_insert = CreateMobileDependentUserInsert.fromJson(
        json['user_insert'],
      ),
      patient_insert = CreateMobileDependentPatientInsert.fromJson(
        json['patient_insert'],
      ),
      familyRelationship_insert =
          CreateMobileDependentFamilyRelationshipInsert.fromJson(
            json['familyRelationship_insert'],
          ),
      patientAccess_insert = CreateMobileDependentPatientAccessInsert.fromJson(
  ...
  bool operator ==(Object other) {
    ...
    final CreateMobileDependentData otherTyped =
        other as CreateMobileDependentData;
  ...
  int get hashCode => Object.hashAll([
    ...
    familyRelationship_insert.hashCode,
...
class CreateMobileDependentVariables {
  ...
  bool operator ==(Object other) {
    ...
    final CreateMobileDependentVariables otherTyped =
        other as CreateMobileDependentVariables;
  ...
  Map<String, dynamic> toJson() {
    ...
    json['relationshipType'] = relationshipType.name;
    return json;
  }
