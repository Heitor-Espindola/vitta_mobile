...
class UpdateMobilePhoneVariablesBuilder {
  ...
  Deserializer<UpdateMobilePhoneData> dataDeserializer = (dynamic json) =>
      UpdateMobilePhoneData.fromJson(jsonDecode(json));
  Serializer<UpdateMobilePhoneVariables> varsSerializer =
      (UpdateMobilePhoneVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<UpdateMobilePhoneData, UpdateMobilePhoneVariables>>
  execute() {
    return ref().execute();
  }
...
class UpdateMobilePhoneUserUpdate {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateMobilePhoneUserUpdate otherTyped =
        other as UpdateMobilePhoneUserUpdate;
  ...
  UpdateMobilePhoneUserUpdate({required this.id});
}
...
class UpdateMobilePhoneData {
  ...
  UpdateMobilePhoneData.fromJson(dynamic json)
    : user_update = json['user_update'] == null
          ? null
          : UpdateMobilePhoneUserUpdate.fromJson(json['user_update']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
  ...
  UpdateMobilePhoneData({this.user_update});
}
...
class UpdateMobilePhoneVariables {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateMobilePhoneVariables otherTyped =
        other as UpdateMobilePhoneVariables;
  ...
  UpdateMobilePhoneVariables({required this.phone});
}
