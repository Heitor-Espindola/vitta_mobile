...
class GetAccessibleFamilyMembersVariablesBuilder {
  ...
  Deserializer<GetAccessibleFamilyMembersData> dataDeserializer = (dynamic json)  => GetAccessibleFamilyMembersData.fromJson(jsonDecode(json));
  
  Future<QueryResult<GetAccessibleFamilyMembersData, void>> execute({QueryFetchPolicy fetchPolicy = QueryFetchPolicy.preferCache}) {
    return ref().execute(fetchPolicy: fetchPolicy);
  }

  QueryRef<GetAccessibleFamilyMembersData, void> ref() {
    
    return _dataConnect.query("GetAccessibleFamilyMembers", dataDeserializer, emptySerializer, null);
  }
}
...
class GetAccessibleFamilyMembersPatientAccesses {
  ...
  validUntil = json['validUntil'] == null ? null : Timestamp.fromJson(json['validUntil']),
  patient = GetAccessibleFamilyMembersPatientAccessesPatient.fromJson(json['patient']);
  @override
  bool operator ==(Object other) {
    ...
    final GetAccessibleFamilyMembersPatientAccesses otherTyped = other as GetAccessibleFamilyMembersPatientAccesses;
  ...
  @override
  int get hashCode => Object.hashAll([accessKind.hashCode, receiveNotifications.hashCode, validUntil.hashCode, patient.hashCode]);
  

  Map<String, dynamic> toJson() {
    Map<String, dynamic> json = {};
    json['accessKind'] = 
    patientAccessKindSerializer(accessKind)
    ;
...
class GetAccessibleFamilyMembersPatientAccessesPatient {
  ...
  user = GetAccessibleFamilyMembersPatientAccessesPatientUser.fromJson(json['user']);
  @override
  bool operator ==(Object other) {
    if(identical(this, other)) {
      return true;
    ...
    final GetAccessibleFamilyMembersPatientAccessesPatient otherTyped = other as GetAccessibleFamilyMembersPatientAccessesPatient;
  ...
  @override
  int get hashCode => Object.hashAll([id.hashCode, patientType.hashCode, legacyPersonId.hashCode, user.hashCode]);
...
class GetAccessibleFamilyMembersPatientAccessesPatientUser {
  ...
  bool operator ==(Object other) {
    ...
    final GetAccessibleFamilyMembersPatientAccessesPatientUser otherTyped = other as GetAccessibleFamilyMembersPatientAccessesPatientUser;
    return id == otherTyped.id && 
...
class GetAccessibleFamilyMembersData {
  ...
  bool operator ==(Object other) {
    ...
    final GetAccessibleFamilyMembersData otherTyped = other as GetAccessibleFamilyMembersData;
