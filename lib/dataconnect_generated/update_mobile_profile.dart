...
class UpdateMobileProfileVariablesBuilder {
  ...
  final FirebaseDataConnect _dataConnect;  UpdateMobileProfileVariablesBuilder phone(String? t) {
   _phone.value = t;
   return this;
  }

  UpdateMobileProfileVariablesBuilder(this._dataConnect, {required  this.name,});
  Deserializer<UpdateMobileProfileData> dataDeserializer = (dynamic json)  => UpdateMobileProfileData.fromJson(jsonDecode(json));
  Serializer<UpdateMobileProfileVariables> varsSerializer = (UpdateMobileProfileVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<UpdateMobileProfileData, UpdateMobileProfileVariables>> execute() {
    return ref().execute();
  }

  MutationRef<UpdateMobileProfileData, UpdateMobileProfileVariables> ref() {
    UpdateMobileProfileVariables vars= UpdateMobileProfileVariables(name: name,phone: _phone,);
    return _dataConnect.mutation("UpdateMobileProfile", dataDeserializer, varsSerializer, vars);
  }
}
...
class UpdateMobileProfileUserUpdate {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateMobileProfileUserUpdate otherTyped = other as UpdateMobileProfileUserUpdate;
...
class UpdateMobileProfileData {
  ...
  user_update = json['user_update'] == null ? null : UpdateMobileProfileUserUpdate.fromJson(json['user_update']);
  @override
  bool operator ==(Object other) {
    if(identical(this, other)) {
      return true;
...
class UpdateMobileProfileVariables {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateMobileProfileVariables otherTyped = other as UpdateMobileProfileVariables;
